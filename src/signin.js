...
return (
   ...
   {props ? <button type="submit" onClick={()=>navigate("/gsignin")}>Import profile from Google</button> : null}
    ...
    <label htmlFor="fname"><b>First name    </b></label>
      <input type="text" onChange={(e) => {setFname(e.target.value);}} placeholder="Enter first name" name="fname" value= {profile.fname} onChange = {handleChange} required/>
      <br></br>
      <label htmlFor="lname"><b>Last name    </b></label>
      <input type="text" onChange={(e) => {setLname(e.target.value);}} placeholder="Enter last name" name="lname" value= {profile.lname} onChange = {handleChange} required/>
      <br></br>
      <label htmlFor="email"><b>Email ID    </b></label>
      <input type="email" onChange={(e) => {setEmail(e.target.value);}} placeholder="Enter email ID" name="email" value= {profile.email} onChange = {handleChange}  required/>
      <br></br>
      <label htmlFor="phno"><b>Phone number    </b></label>
      <input type="number" onChange={(e) => {setPhoneNo(e.target.value);}} maxLength={10} placeholder="Enter phone number" name="phno" value= {profile.phno} onChange = {handleChange}  required/>
      <br></br>
...
<label htmlFor="css">Owner</label><br></br>
      ...
      <input type="password" onChange={(e) => {setPassword(e.target.value);}} minLength={5} placeholder="Enter password" name="pswd" value= {profile.pswd} onChange = {handleChange} required/>
      <br></br>
